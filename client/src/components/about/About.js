          ...
          <Col md={8}>
            ...
            <Card.Body>
              <Card.Text className='about-description'>
                Hi 👋! My name is Rossana, I&apos;m Italian and I have been living in London for the last ten years. Before moving to London I travelled all over the world, which instilled in me a lifelong love of languages, I speak Italian (obviously), English, and Russian.
                <br />
                <br />
